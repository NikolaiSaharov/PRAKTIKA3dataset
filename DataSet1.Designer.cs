...
namespace PRAKTIKA3.DataSet1TableAdapters {
...
SELECT PassengerId, FirstName, LastName, Email, Phone FROM Passengers WHERE (PassengerId = @PassengerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PRAKTIKA3.Properties.Settings.Default.AVIACASSA2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT P.PassengerId, P.FirstName, P.LastName, P.Email, P.Phone, T.TicketId, T.Se" +
                "atNumber, T.Class, T.Price\r\nFROM Passengers P\r\nLEFT JOIN Tickets T ON P.Passenge" +
                "rId = T.PassengerId;\r\n";
        ...
        public virtual DataSet1.PassengersDataTable GetDataBy() {
...
SELECT TicketId, PassengerId, SeatNumber, Class, Price FROM Tickets WHERE (TicketId = @TicketId)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.TicketsDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            DataSet1.TicketsDataTable dataTable = new DataSet1.TicketsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
